...
Friend Class boreader_panelcontrol
    ...
    Private Sub Command8_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command8.Click
        ...
        If CKT_GetDeviceClock(IDNumber, devclock) Then
            msg = "Fecha del reloj : " & devclock.Year_Renamed & "-" & devclock.Month_Renamed & "-" & devclock.Day_Renamed & Chr(10) & "     Hora : " & devclock.Hour_Renamed & ":" & devclock.Minute_Renamed & ":" & devclock.Second_Renamed
            MessageBox.Show(msg, "Detalles", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
    ...
    Private Sub Command19_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command19.Click
        ...
        If CKT_ListPersonInfoEx(IDNumber, pLongRun) Then
            ...
            Do While True
                ...
                '-----------------------------------------------
                MessageBox.Show("Ret : " & Ret & "  RecordCount : " & RecordCount & "  RetCount : " & RetCount & "  pPersons : " & pPersons)
                If Ret = 0 Then
                    'Exit Sub
                End If
                '-----------------------------------------------
                ...
                If (Ret <> 0) Or (1 = 1) Then

                    MessageBox.Show("Ret : " & Ret & "  RecordCount : " & RecordCount & "  RetCount : " & RetCount & "  pPersons : " & pPersons)

                    ptemp = pPersons
                    For i = 0 To RecordCount    'RetCount - 1
    ...
    Private Sub Command31_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command31.Click
        ...
        If CKT_GetDeviceInfo(IDNumber, devnfo) Then
            ...
            msg = msg & "Versión : " & devnfo.MajorVersion & "." & devnfo.MinorVersion & Chr(10)
            MessageBox.Show("Id Reloj : " + msg, "Atención", MessageBoxButtons.OK, MessageBoxIcon.Information)
            btnEnd.PerformClick()
        End If
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStart.Click
        ...
        If RadioNet.Checked Then
            ...
            lblUltima.Text = "Conexión al reloj " & IDNumber & " exitosa"
            lblUltima.Refresh()
        End If
    End Sub
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        'Ret = CKT_ListPersonInfo(i, RecordCount, pPersons)

        'MessageBox.Show("Ret : " & Ret & "  RecordCount : " & RecordCount & "  i : " & i & "  pPersons : " & pPersons)

        'Call PCopyMemory(person, pPersons, Marshal.SizeOf(person))

        'MessageBox.Show(person.PersonID)

        If CKT_ListPersonInfoEx(IDNumber, pLongRun) Then
            MessageBox.Show("IDNumber:" & IDNumber & "  " & "pLongRun:" & pLongRun)
    ...
    Private Sub Command22_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Command22.Click
        Dim nRespuesta As Integer

        btnStart.PerformClick()

        nRespuesta = MessageBox.Show("  Está a punto de eliminar todas las fichadas del reloj !!!  ", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)
        If nRespuesta = DialogResult.No Then
        Else
            ' Yes pressed

            If CKT_ClearClockingRecord(IDNumber, 0, 0) Then
                MessageBox.Show("  Se eliminaron todas las fichadas del reloj !!  ", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Else
                MessageBox.Show("  No se pudo eliminar las fichadas del reloj !!  ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
        End If
    End Sub

    Private Sub Command9_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetDate.Click
        Dim tim As SYSTEMTIME
        GetLocalTime(tim)

        If CKT_SetDeviceDate(IDNumber, tim.wYear, tim.wMonth, tim.wDay) Then
            MessageBox.Show("  Fecha actualizada  ", "Atención", MessageBoxButtons.OK , MessageBoxIcon.Information)
        End If
        ...
        If CKT_SetDeviceTime(IDNumber, tim.wHour, tim.wMinute, tim.wSecond) Then
            MessageBox.Show("  Hora actualizada  ", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
End Class